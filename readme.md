...
1. Copy the `formatter.lua` file into the pragtical `plugins` folder

2. To install any specific formatter, copy the corresponding file into the `plugins` folder. List of formatters is at the top of this file.
...
- make sure to add the pragtical mod version tag at the top
